...
const variantStyles = {
  primary:
    "rounded-full bg-neutral-900 py-1 px-3 text-white hover:bg-neutral-700 dark:bg-primary-400/10 dark:text-primary-400 dark:ring-1 dark:ring-inset dark:ring-primary-400/20 dark:hover:bg-primary-400/10 dark:hover:text-primary-300 dark:hover:ring-primary-300",
  secondary:
  ...
  filled:
    "rounded-full bg-neutral-900 py-1 px-3 text-white hover:bg-neutral-700 dark:bg-primary-500 dark:text-white dark:hover:bg-primary-400",
  outline:
