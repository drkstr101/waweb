                    ...
                    >
                      <h3>
                        <Tab
                          className={clsx(
                            ...
                            selectedIndex === featureIndex
                              ? "text-secondary-600 lg:text-white"
                              : "text-secondary-100 hover:text-white lg:text-white"
                          )}
                        >
                      ...
                      <p
                        className={clsx(
                          ...
                          selectedIndex === featureIndex
                            ? "text-white"
                            : "text-secondary-100 group-hover:text-white"
                        )}
                      >
                        {feature.description}
                      </p>
              ...
              <Tab.Panels className="lg:col-span-7">
                {features.map((feature) => (
                  <Tab.Panel key={feature.title} unmount={false}>
                    ...
                    <div className="shadow-secondary-900/20 mt-10 w-[45rem] overflow-hidden rounded-xl bg-neutral-50 shadow-xl sm:w-auto lg:mt-0 lg:w-[67.8125rem]">
                      <Image
                        className="w-full"
                        src={feature.image}
                        alt=""
