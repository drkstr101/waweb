...
export interface HighlightsSectionProps extends HtmlHTMLAttributes<HTMLDivElement> {
...
export function Highlights({
  ...
  return (
    <section
      id="company"
      aria-label="What we have to offer"
      className={clsx("bg-gradient-to-b from-white to-neutral-200 py-24", className)}
      {...props}
    >
        ...
        <div className="relative isolate overflow-hidden bg-neutral-900 px-6 py-10 sm:rounded-3xl sm:px-10 sm:py-12 lg:py-24 xl:p-24">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center lg:gap-y-0">
            <div className="lg:row-start-2 lg:max-w-md">
              ...
              <p className="font-book mt-6 text-lg leading-8 text-neutral-300">
                ...
                {features.map((feature) => (
                  <div key={feature.name} className="relative">
                    <dt className="ml-9 inline-block font-semibold text-white">
                      <feature.icon
                        className="text-accent-500 absolute left-1 top-1 h-5 w-5"
                        aria-hidden="true"
                      />
                      {feature.name}
                    </dt>{" "}
          ...
          >
            <div
              className="from-primary-400 to-secondary-500 aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr opacity-25"
              style={{
                clipPath:
