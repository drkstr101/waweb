  ...
  return (
    ...
    >
      <div
        id={`${id}-title`}
        aria-hidden="true"
        className="group-aria-selected:text-primary-600 dark:group-aria-selected:text-primary-400 text-sm text-neutral-700 dark:text-neutral-300"
      >
  ...
  if (collection.items.length === 0) {
    return (
      <p className="px-4 py-8 text-center text-sm text-neutral-700 dark:text-neutral-400">
        ...
        <span className="break-words text-neutral-900 dark:text-white">{query}</span>
        &rdquo;
      </p>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 overflow-y-auto px-4 py-4 sm:px-6 sm:py-20 md:py-32 lg:px-8 lg:py-[15vh]">
        <Dialog.Panel className="mx-auto overflow-hidden rounded-xl bg-white shadow-xl dark:bg-neutral-800 dark:ring-1 dark:ring-neutral-700 sm:max-w-xl">
